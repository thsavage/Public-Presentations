...
# ## Class 4 and 5: The Multiclass Challenge
# 
...
# 
# 
# * The benefits and challendges of open source.
# 
# 
# 
...
# 
# 
# ### Note the Algorithmic Development
# * Linear regression (very old).
#     * No hyperparameter tuning.
#     * Embedded in an optimization problems, min SSR$(\beta)$ wrt $\beta$.
#     * Ease of interpretation: for every 100 bps decrease in the 10-year U.S. Treasury, office cap rates decline by 45 bps.
#     * Classical hypothesis testing and OOS prediction (once we have enough data).
# 
# 
# 
# * Logistic regression (old), but very useful to develop a predictor, $\hat{y}$.
#     * Development of train/test splits or OOS.  
# 
# 
# 
# * Decision rules are introduced as the first "artficial intelligence" called **knowledge engineering** in the 1950's.  
#     * As AI, big failure.
#     * But it generated a new line of research that would ultimately lead to ensemble models.
#     * Start with a single rule or tree.
#     * Build a forest with many trees.
#     * Continue the theme: xgboost.
...
# 
# 
# ### Let's Use the Curated Albalone Data Again (80/20 Train/Test Split)
...
# ### Notes
# * Accuracy is well below that of the basic Random Forest.
# 
# 
# 
# * Note the large misclassification of type 1, as well as type 2.
...
# Reminder of the accuracy of other algorithms.
...
get_ipython().system('jupyter nbconvert --to script "CRA Classes 4 and 5.ipynb"')
